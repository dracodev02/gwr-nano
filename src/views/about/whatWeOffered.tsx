...
const WhatWeOffered = () => {
  ...
  return (
    <section className="container-custom py-[104px] flex flex-col gap-4">
      ...
      <Divider />
      <p className="mb-4 mr-[56%]">
        {lang(languages.A_unique_revolutionary_solution)}
      </p>
      <div className="grid grid-cols-3">
        <div className="shadow-[0_0_10px_0_rgba(0,0,0,0.2)] flex flex-col">
          <Image
            src={"/images/bg-what-we-offer-1.jpg"}
            alt="project"
            width={512}
            height={192}
            className="h-[192px] object-contain"
          />
        ...
        <div className="bg-white flex flex-col">
          ...
          <div className="p-8 flex flex-col gap-5 justify-between flex-1">
            <div>
              <h3 className="text-2xl">{lang(languages.Outstanding_in_the)}</h3>
